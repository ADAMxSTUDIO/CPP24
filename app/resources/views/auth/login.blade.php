...
<body>
    <section class="container-fluid p-4 w-25">
        ...
        <h3 class="text-center" style="font-size: 3em; font-weight: 700; margin: 20px;">LOGIN</h3><br>
        <form method="POST" action="{{ route('login') }}">
            ...
            <input name="submit" type="submit" class="btn btn-success w-100 mt-2" value="Login" />
        </form>
    </section>
